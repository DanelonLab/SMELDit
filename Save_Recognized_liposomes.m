...
Nimg=[1 2 3]; % Number of images in each sample (length should match the value of Nsample)


for sampleNumber = 1:Nsample
    ...
    dsGreen_channel='c2'; %suffix for dsGreen channel
    mCherry_channel='c1'; %suffix for mCherry channel
    ...
    experimentDate='2022_06_23'; %date of experiment is used to name the datafile
    folder = ['yourfilepath/foldercontainingthecodefile/Recognized Liposomes/' sampleName];
    ...
    [Area{i}, dsGreen{i}, dsGreen_var{i}, centroids{i}, mCherry{i}, mCherry_var{i}, Cy5{i}] = image_analysis(I_Cy5, I_mCherry, I_dsGreen);
    ...
    save(['data_' experimentDate '_' sampleName],'Area','R','dsGreen','dsGreen_var','mCherry','mCherry_var','Cy5','centroids','ImInx','Nimages','folder','sampleName')
end

%% image analysis

function [Area, dsGreen, dsGreen_var, Centroids, mCherry, mCherry_var, Cy5] = image_analysis(I_Cy5,I_mCherry, I_dsGreen)
